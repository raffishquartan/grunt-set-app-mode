...
function ModeGroupConfig(mode_group_files, expected_modes) {
  if(mode_group_files.src === undefined) {
    throw new Error("ModeGroupConfig src is undefined");
  }

  var src_string = mode_group_files.src[0];
  if(typeof src_string !== "string") {
    throw new Error("ModeGroupConfig src '" + src_string + "' is wrong type: " + typeof src_string);
  }
